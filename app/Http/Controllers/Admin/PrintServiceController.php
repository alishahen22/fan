...
class PrintServiceController extends Controller
{
    ...
    {
        $printService = PrintService::findOrFail($id);
    ...
    {
        PrintService::findOrFail($id)->delete();
    ...
    public function getData(Request $request)
    {
        return DataTables::eloquent($this->filter($request))
            ...
            ->editColumn('price', fn($row) => number_format($row->price, 2) . ' ج.م')
