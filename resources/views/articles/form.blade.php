            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="tab-pane mb-3 active" id="arabic-data" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="ckeditor-classic" id="desc_ar">
                                        <input type="hidden" name="desc_ar"
                            ...
                            <div class="tab-pane mb-3" id="english-data" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="ckeditor-classic" id="desc_en">
                                        <input type="hidden" name="desc_en"
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="manufacturer-name-input">@lang('Published at')</label>
                            <input type="date" class="form-control" id="published_at" name="published_at"
                                   value="{{ isset($category) ? $category->published_at : old('published_at') }}"
                                   required>
                            <div class="invalid-feedback">@lang('Please Enter a value')</div>
                        </div>
                        <div class="mb-3">
