            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('areas.index',$id)}}">المناطق</a></li>
                        @if(isset($title))
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- end tab content -->
                        <div class="mb-3">
                            <label class="form-label" for="manufacturer-name-input">تكلفة الشحن</label>
                            <input type="number" min="0" class="form-control" id="cost" name="cost"
                                   value="{{ isset($category) ? $category->cost : old('title_en') }}"
                                   required>
                            <div class="invalid-feedback">@lang('Please Enter a value')</div>
                        </div>
                    </div>
