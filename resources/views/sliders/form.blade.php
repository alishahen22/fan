            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{--                                <select id="type" class="js-example-basic-single" name="type" required>--}}
                        {{--                                    <option value="" disabled selected>@lang('Select Type')</option>--}}
                        {{--                                    <option value="url" {{ isset($slider) && $slider->type == 'url'  ? 'selected' : '' }}>@lang('URL')</option>--}}
                        {{--                                    <option value="product" {{ isset($slider) && $slider->type == 'product'  ? 'selected' : '' }}>@lang('Product')</option>--}}
                        {{--                                    <option value="service" {{ isset($slider) && $slider->type == 'service'  ? 'selected' : '' }}>@lang('Service')</option>--}}
                        {{--                                </select>--}}
                        {{--                                <div class="invalid-feedback">--}}
                        {{--                                    @lang('Please Choose a value')--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                            <div id="productDiv" class="mb-3" style="display: none;">--}}
                        {{--                                <label for="product_id" class="form-label">@lang('Select Product')</label>--}}
                        {{--                                <select id="product_id" class="js-example-basic-single" name="product_id">--}}
                        {{--                                    <option value="" disabled selected>@lang('Select Product')</option>--}}
                        {{--                                    @foreach($products as $product)--}}
                        {{--                                        <option value="{{ $product->id }}" {{ isset($slider) && $slider->product_id == $product->id  ? 'selected' : '' }}>{{ $product->{'title_'.app()->getLocale()} }}</option>--}}
                        {{--                                    @endforeach--}}
                        {{--                                </select>--}}
                        {{--                                <div class="invalid-feedback">--}}
                        {{--                                    @lang('Please Choose a value')--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                            <div id="serviceDiv" class="mb-3" style="display: none;">--}}
                        {{--                                <label for="service_id" class="form-label">@lang('Select Service')</label>--}}
                        {{--                                <select id="service_id" class="js-example-basic-single" name="service_id">--}}
                        {{--                                    <option value="" disabled selected>@lang('Select Service')</option>--}}
                        {{--                                    @foreach($services as $service)--}}
                        {{--                                        <option value="{{ $service->id }}" {{ isset($slider) && $slider->service_id == $service->id  ? 'selected' : '' }}>{{ $service->{'title_'.app()->getLocale()} }}</option>--}}
                        {{--                                    @endforeach--}}
                        {{--                                </select>--}}
                        {{--                                <div class="invalid-feedback">--}}
                        {{--                                    @lang('Please Choose a value')--}}
                        ...
                        {{--                                <label class="form-label" for="url">@lang('URL')</label>--}}
                        {{--                                <input type="url" class="form-control" id="url" name="url"--}}
                        {{--                                       placeholder="@lang('Please Enter a value')" value="{{ isset($slider) ? $slider->url : old('url') }}">--}}
