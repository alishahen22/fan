                    ...
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                ...
                                <input class="form-check-input" name="is_active" value="1" {{ isset($modell)  ? ($modell->is_active ? 'checked' : '') : 'checked' }} type="checkbox" id="input-group-showcode">
                            </div>
                        </div>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane mb-3 active" id="arabic-data" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_ar" name="title_ar"
                                           placeholder="@lang('Enter Title Ar')" value="{{ isset($modell) ? $modell->title_ar : old('title_ar') }}" required>
                            ...
                            <div class="tab-pane mb-3" id="english-data" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_en" name="title_en"
                                           placeholder="@lang('Enter Title En')" value="{{ isset($modell) ? $modell->title_en : old('title_en') }}" required>
                                    <div class="invalid-feedback">@lang('Please Enter a value')</div>
                                </div>
                                <!-- end row -->
                            </div>
                            <div class="mb-3">
                                <label for="brand_id" class="form-label">@lang('translation.Select Brand')</label>
                                <select id="brand_id" class="js-example-basic-single" name="brand_id" required>
                                    <option value="" disabled selected>@lang('translation.Select Brand')</option>
                                    @foreach($brands as $brand)
                                        <option value="{{ $brand->id }}" {{ isset($modell) && $modell->brand_id == $brand->id  ? 'selected' : '' }}>{{ $brand->{'title_'.app()->getLocale()} }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="image" accept="image/*" type="file" class="dropify" data-height="100" @isset($modell) data-default-file="{{ $modell->image }}" @endisset/>
                            </div>
                            <!-- end tab pane -->
                        </div>
                        <!-- end tab content -->
