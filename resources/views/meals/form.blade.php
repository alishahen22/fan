            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="tab-pane mb-3 active" id="arabic-data" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="desc_ar"
                                              name="desc_ar">{{ isset($category) ? $category->desc_ar : old('desc_ar') }}</textarea>
                                    <div class="invalid-feedback">@lang('Please Enter a value')</div>
                                </div>
                                <!-- end row -->
                            </div>
                            ...
                            <div class="tab-pane mb-3" id="english-data" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="desc_en"
                                              name="desc_en">{{ isset($category) ? $category->desc_en : old('desc_en') }}</textarea>
                                    <div class="invalid-feedback">@lang('Please Enter a value')</div>
                                </div>
                                <!-- end row -->
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="col-lg-12">
                                <h6 class="fw-semibold">خصائص الوجبة</h6>
                                <select class="js-example-basic-multiple select2" name="attributes[]" required
                                        multiple="">
                                    @foreach(\App\Models\Attribute::active()->get() as $attribute)
                                        <option value="{{$attribute->id}}"
                                        @if(isset($category) && $category->attributes->contains('attribute_id', $attribute->id))
                                        selected
                                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input name="image" accept="image/*" type="file" class="dropify" data-height="100"
                                   @isset($category) data-default-file="{{ $category->image }}" @endisset/>
                        </div>
                        <!-- end tab content -->
                    </div>
                    <!-- end card body -->
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">@lang('meal Images')</h4>
                    </div><!-- end card header -->

                    <div class="card-body">

                        {{--                        <h5 class="fs-14 mb-1">@lang('translations.Product Images')</h5>--}}
                        <p class="text-muted">@lang('Add meal Gallery Images.')</p>
                                        ...
                                        <div class="border rounded">
                                            <div class="d-flex p-2">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar-xl bg-light rounded">
                                                        <img data-dz-thumbnail class="img-fluid rounded d-block"
                                                             src="{{ $image->image }}" alt="Dropzone-Image"/>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    {{--                                            <div class="pt-1">--}}
                                                ...
                                                <div class="flex-shrink-0 ms-3">
                                                    <a href="{{route('meals.images.delete',$image->id)}}" data-dz-remove
