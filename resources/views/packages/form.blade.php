            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="manufacturer-name-input">@lang('days count')</label>
                            <input type="number" min="0" class="form-control" id="days_count" name="days_count"
                                   placeholder="@lang('Enter Title En')" value="{{ isset($category) ? $category->days_count : old('days_count') }}" required>
                            <div class="invalid-feedback">@lang('Please Enter a value')</div>
                        </div>
                        <!-- end tab content -->
                    </div>
