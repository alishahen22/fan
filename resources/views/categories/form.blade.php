            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- end tab content -->
                        <div class="mb-3">
                            <label for="type" class="form-label">@lang('lang.Select type')</label>
                            <select id="type" class="form-control js-example-basic-single" name="type" required>
                                @foreach(\App\Models\Category::TYPE as $type)
                                    <option
                                        value="{{ $type }}" {{ isset($category) && $category->type == $type  ? 'selected' : '' }}>{{ trans('lang.'.$type) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
