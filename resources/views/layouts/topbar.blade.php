...
{{--                                <div class="row align-items-center">--}}
{{--                                    <div class="col">--}}
{{--                                        <h6 class="m-0 fs-16 fw-semibold text-white"> @lang('translation.Notifications') </h6>--}}
{{--                                    </div>--}}
...
{{--                                            @lang('translation.All Notifications')--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li class="nav-item waves-effect waves-light">--}}
...
{{--                                                </div>--}}
{{--                                                <div class="flex-grow-1">--}}
{{--                                                    <a href="{{ route('orders.show',$order->id) }}" class="stretched-link">--}}
{{--                                                        <h6 class="mt-0 mb-2 lh-base"><b>@lang('translation.New Order Has Been Created')</b>--}}
{{--                                                            <span class="text-secondary">{{ $order->order_num }}</span>--}}
{{--                                                        </h6>--}}
{{--                                                    </a>--}}
...
{{--                                        <a href="{{ route('orders.index') }}" class="btn btn-soft-success waves-effect waves-light">--}}
{{--                                            @lang('translation.View All Orders') <i class="ri-arrow-right-line align-middle"></i></a>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
