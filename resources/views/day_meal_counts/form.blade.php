            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="manufacturer-name-input">@lang('meal count')</label>
                            <input type="number" min="0" class="form-control" id="meal_count" name="meal_count"
                                   placeholder="@lang('Enter Title En')" value="{{ isset($category) ? $category->meal_count : old('meal_count') }}" required>
                            <div class="invalid-feedback">@lang('Please Enter a value')</div>
                        </div>
                        <!-- end tab content -->
                    </div>
