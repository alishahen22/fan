                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                ...
                                <input class="form-check-input" name="is_active" value="1" {{ isset($data)  ? ($data->is_active ? 'checked' : '') : 'checked' }} type="checkbox" id="input-group-showcode">
                            </div>
                        </div>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                            ...
                            <div class="tab-pane mb-3 active" id="arabic-data" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_ar" name="title_ar"
                                           placeholder="@lang('Enter Title Ar')" value="{{ isset($data) ? $data->title_ar : old('title_ar') }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="desc_ar" name="desc_ar">{{ isset($data) ? $data->desc_ar : old('desc_ar') }}</textarea>
                                    <div class="invalid-feedback">@lang('Please Enter a value')</div>
                                </div>
                                <!-- end row -->
                            </div>
                            ...
                            <div class="tab-pane mb-3" id="english-data" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_en" name="title_en"
                                           placeholder="@lang('Enter Title En')" value="{{ isset($data) ? $data->title_en : old('title_en') }}" required>
                                    <div class="invalid-feedback">@lang('Please Enter a value')</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="manufacturer-name-input">@lang('Description En')</label>
                                    <textarea type="text" class="form-control" id="desc_en" name="desc_en">{{ isset($data) ? $data->desc_en : old('desc_en') }}</textarea>
                                    <div class="invalid-feedback">@lang('Please Enter a value')</div>
                                </div>
                                <!-- end row -->
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="image" accept="image/*" type="file" class="dropify" data-height="100" @isset($data) data-default-file="{{ $data->image }}" @endisset/>
                        </div>
                        <!-- end tab content -->
                    </div>
                    <!-- end card body -->
